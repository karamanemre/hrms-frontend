            ...
            <Grid.Column width={11}>
              <h3 style={{float:"left",fontSize:"2em"}}>Cv Ekle</h3>
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="coverletteruptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
                ...
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="schooluptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
                ...
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="programminglanguageuptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
                ...
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="/languageuptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
                ...
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="/technologyuptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
                ...
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="/jobexperienceuptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
                ...
                <Card fluid style={{position:"relative",height:"400px"}} >
                  ...
                  <Card.Content><Link to="/socialmediauptade"><Button color="green"  style={{position:"absolute",bottom:"10em",left:"0",width:"300px",height:"50px"}}>Güncelle </Button></Link></Card.Content>
                </Card>
